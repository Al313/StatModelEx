...
```{r}
# Load data
salary <-  read.csv("day5/data/salary.txt", sep = ",", header = TRUE)
...
We can interpret the Estimate as follows: The intercept is the base salary for every teacher. With each year of experience, we can add `r model_B$coefficients[2,1]`$ to the salary, and depending on the districtSize, we can do the same.
